      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
            Strata sits between your applications and backend infrastructure —
            handling authentication, request routing, traffic management,
            backend monitoring, and operational observability through a unified
            proxy layer.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-4 items-center">
                ...
                <div className="relative z-10">
                  ...
                  <div className="mt-4 flex flex-wrap justify-center gap-2">
                    {[
                      ...
                      <span
                        key={item}
                        className="px-2 py-1 text-xs rounded-md bg-secondary border border-border text-muted-foreground"
                      >
                        {item}
                      </span>
                    ))}
            ...
            <div className="lg:col-span-1 flex flex-col items-center gap-3">
              {[
                ...
                <div
                  key={index}
                  className="w-32 p-3 rounded-xl bg-card border border-border text-center"
                >
                  ...
                  <span className="block text-xs text-muted-foreground mt-1 capitalize">
                    {backend.status}
                  </span>
                </div>
              ))}
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
          {[
            {
              value: "Proxy Layer",
              label: "Centralized Request Routing",
            },
            {
              value: "Observability",
              label: "Traffic & Backend Monitoring",
            },
            {
